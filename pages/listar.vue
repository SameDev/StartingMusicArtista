<template>
  ...
  <section class="container justify-center items-center content-center mx-auto bg-secondary w-full p-7 m-10 rounded-md font-nunito" v-else>
...
onBeforeMount(async () => {
  if (process.client) {
    ...
    jwtToken = cookieToken.value as string;
  }
});
